  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-950 text-white">
      <div className="pointer-events-none absolute inset-0">
        <div
          className="absolute -top-32 left-1/2 h-96 w-96 -translate-x-1/2 rounded-full bg-blue-500/20 blur-3xl"
          aria-hidden="true"
        />
        <div
          className="absolute bottom-0 right-0 h-96 w-96 translate-x-1/3 bg-purple-500/20 blur-3xl"
          aria-hidden="true"
        />
      </div>
      ...
      <div className="relative">
        <SiteNav />
        <main id="page-content" className="container mx-auto px-4 pb-16 pt-24" tabIndex={-1}>
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              ...
              >
                <Link
                  ...
                  data-analytics-goal="primary-cta"
                >
                  {primaryCta.label}
              ...
              {secondaryCta ? (
                ...
                >
                  <Link href={secondaryCta.href} className="flex items-center gap-2" data-analytics-goal="secondary-cta">
                    {secondaryCta.icon ?? <ArrowLeft className="h-5 w-5" aria-hidden="true" />}
                    {secondaryCta.label}
                  </Link>
                </Button>
              ) : null}
        ...
        <div className="container mx-auto px-4 pb-24">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {highlights.map((highlight, index) => (
              ...
              >
                <div
                  className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-blue-500/10 text-blue-300"
                  aria-hidden="true"
                >
                  {highlight.icon}
                </div>
